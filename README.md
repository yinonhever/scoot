...
![Design preview for the Scoot website coding challenge](./designs/preview.jpg)
...
Your task is to build out the project to the designs inside the `/designs` folder. You'll see that the original [Sketch design file has been included](./designs/sketch/scoot.sketch) in the project.
...
All the required assets for this project are in the `/assets` folder. The assets are already exported for the correct screen size and optimized. Images without devices specified can be used across all device sizes.
